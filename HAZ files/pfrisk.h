c     Set array dimensions
     ...
     1        MAX_ATTEN, MAX_FTYPE, MAX_S7
      integer MAX_KY, MAX_ALPHAD, MAX_SF, MAX_DAMT, Max_LOOP


      parameter (MAX_FLT=600, MAX_SEG=300, MAX_INTEN=18, MAX_PROB=3, 
     ...
     1           MAX_ATTEN=60, MAX_FTYPE=3, MAX_S7=70000)
      parameter (MAX_KY =3, MAX_ALPHAD=9, MAX_SF=3,MAX_DAMT=3, MAX_LOOP=41)
